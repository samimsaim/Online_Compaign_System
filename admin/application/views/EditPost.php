    ...
    <div class="page-content">
        ...
        <div class="portlet light ">
            ...
            <div class="portlet-body form" style="margin-right: 20px;">
                <form class="form-horizontal" method="post" action="<?=base_url()?>index.php/KandidController/UpdatePost?id=<?=$_GET['id'];?>" enctype="multipart/form-data">
                    <div class="form-body">
                  ...
                  <?php foreach ($data as $row) {?>
                    <div class="form-group form-md-line-input has-success">
                     ...
                     <div class="col-md-9">
                     <textarea class="ckeditor" name="comment" rows="15"><?php echo $row->post_details; ?></textarea>
                     <div class="form-control-focus"> </div>
                        ...
                        <div class="row">
                            <div class="col-md-offset-2 col-md-10">
                              <input type="hidden" name="id" value="<?=$row->kan_id;?>">
                                ...
                                <input type="submit" name="update" class="btn blue" value="ذخیره"/>
                            </div>
                        </div>
                    </div>
                </form>
