                            ...
                            <div class="row">
                                ...
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase"> لیست مدیران</span>
                                    </div>
                                    <div class="actions">
                                ...
                                <?php foreach ($user as  $row) {?>
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            <a class="btn btn-circle btn-icon-only btn-default" href="<?php echo base_url()?>index.php/usersController/AdminDetail?id=<?=$row->id;?>" data-toggle="tooltip" data-placement="top" title="مشاهده"  ><span class="glyphicon glyphicon-eye-open "></a>
                                            <a class="btn btn-circle btn-icon-only btn-success" href="<?php echo base_url()?>index.php/usersController/UpdateAdmin?id=<?=$row->id;?>" data-toggle="tooltip" data-placement="top" title="ویرایش">
