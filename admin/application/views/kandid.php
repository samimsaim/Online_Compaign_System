<?php if($_SESSION['user_level']==2){
    redirect('usersController/kandidAcount');
} ?>
<!-- BEGIN CONTENT -->
                        ...
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6" style=" margin-bottom: -8px;">
                                    <div class="btn-group">
                                       <!--  <a href="<?php echo base_url()?>index.php/usersController/AddKandidView" id="sample_editable_1_new" class="btn sbold green">اضافه نمودن<i class="fa fa-plus"></i></a> -->
                                    </div>
                                </div>
                                <div class="col-md-6">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: center;">حساب کاربری</th>
                            ...
                            <tbody>
                                <?php foreach ($user as  $row) {?>
                                    <tr>
                                        ...
                                        <td style="text-align: center;"><?=ucfirst($row->kan_phone)?></td>
                                         <td style="text-align: center;">
                                            <a href="<?php echo base_url()?>index.php/usersController/AddKandidView?id=<?=$row->kan_id;?>" class="fa fa-plus dropdown-toggle btn btn-circle btn-icon-only btn-defualt"></a>
                                            <a class="btn btn-circle btn-icon-only btn-success" href="<?php echo base_url()?>index.php/usersController/EditKan?id=<?=$row->kan_id;?>" data-toggle="tooltip" data-placement="top" title="ویرایش">
                                     <span class="fa fa-pencil"></span></a> 
                                        </td>
                                        <td style="text-align: center;">
                                            <a class="btn btn-circle btn-icon-only btn-default" href="<?php echo base_url()?>index.php/usersController/KandidDetail?id=<?=$row->kan_id;?>" data-toggle="tooltip" data-placement="top" title="مشاهده"  ><span class="glyphicon glyphicon-eye-open "></a>
...
<script type="text/javascript">
    ...
    function delete_record(id){
        ...
        if(r==true)
            window.location=url+"index.php/usersController/deleteKandid?id="+id;
        else
            return false;
    }
</script>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="<?php echo base_url()?>index.php/usersController/kandid" class="btn btn-primary">بستن</a>
                </div>
            </div>
        </div>
    </div>
