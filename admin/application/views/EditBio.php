        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption font-green-haze">
                    ...
                    <span class="caption-subject bold uppercase">ویرایش  بیوگرافی</span>
                </div>
                <div class="actions">
...
<?php foreach ($data as $row ) { ?>
            <div class="portlet-body form" style="margin-right: 20px;">
                <form class="form-horizontal" method="post" action="<?=base_url()?>index.php/KandidController/updateBio" enctype="multipart/form-data">
                    <div class="form-body">
                    <div class="form-group form-md-line-input has-success">
                     <label class="col-md-3 control-label" for="form_control_1">بیوگرافی</label>
                     <div class="col-md-9">
                     <textarea class="ckeditor" name="biography"  rows="15"><?php echo $row->boi_kandid ?></textarea>
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-2 col-md-10">
                                ...
                                <input type="submit" name="EditBio" class="btn blue" value="ذخیره"/>
                            </div>
                        </div>
                        <?php }?>
                    </div>
