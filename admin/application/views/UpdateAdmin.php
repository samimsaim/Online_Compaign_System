    ...
    <div class="page-content">
        ...
        <div class="portlet light ">
            ...
            <div class="portlet-body form">
                <form class="form-horizontal" method="post" action="<?=base_url()?>index.php/usersController/checkEditAdmin" enctype="multipart/form-data">
                    <div class="form-body">
                      <div class="row">
                    ...
                    <div class="row">
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_pos)) echo 'has-error' ?>">
                            <label class="col-md-3 control-label" style="font-weight: bold">نوعیت شخص</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="position" value="<?=$value->person_type?>" placeholder="کارمند اداری">
                                <div class="form-control-focus"> </div>
                    ...
                    <div class="row">
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_phone)) echo 'has-error' ?>">
                            <label class="col-md-3 control-label" style="font-weight: bold">شماره تیلفون</label>
                            <div class="col-md-9">
                        ...
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_username)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="username" value="<?=$value->username?>" placeholder="administrator">
                                <div class="form-control-focus"> </div>
                        ...
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_privilege)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <select class="form-control" name="privilege">
                                    <option <?php if(!empty($Field_data['privilege']) && $Field_data['privilege'] == 0) echo ' selected '?> value="0"><?php if($value->user_level==1) echo "مدیر"; else echo "کاندی";?></option>
                                    <option <?php if(!empty($Field_data['privilege']) && $Field_data['privilege'] == 'admin') echo ' selected '?> value="1">مدیر</option>
                                    <option <?php if(!empty($Field_data['privilege']) && $Field_data['privilege'] == 'guest') echo ' selected '?> value="2">کاندید</option>
                                </select>
                                <div class="form-control-focus"> </div>
